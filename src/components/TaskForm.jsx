...
const TaskForm = (props) => {
    ...
    const titleStyle = {
        finished: "block text-primary-gray line-through py-2 px-4 border border-primary-gray rounded w-full",
        notFinished: "block text-primary-emperor py-2 px-4 border border-primary-gray rounded w-full",
    };
            ...
            <div className="w-full space-y-4">
                <div className="flex justify-between items-center">
                    <div className="w-full max-w-[320px]">
                        <input type="text" className={!checkbox ? titleStyle.notFinished : titleStyle.finished} placeholder="Type Task Title" />
                    </div>
                    ...
                    <div>
                        <div className="flex gap-4">
                            ...
                            <input
                                ...
                                onFocus={(e) => {
                                    setInputType(e.target.type === "text" ? "date" : "text");
                                }}
                            />
                        </div>
                        <div className="flex gap-4">
                            <img src={PencilIcon} alt="schedule icon" />
                            <input type="text" className=" border-primary-gray rounded w-full disabled:bg-white" value="lorem tesetin" disabled />
                        </div>
                    </div>
                )}
            </div>
